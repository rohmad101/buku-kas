    ...
    return (
      <View style={[styles.container, {alignItems: 'center'}]}>
        <Header
          ...
          centerComponent={{ text: 'Home', style: { color: '#fff', fontSize: width * 0.035 } }}
        />
        <ScrollView>
          <View style={{alignItems: 'center'}}>
            <View style={{borderWidth: 0.5, borderRadius: 8, width: width * 0.95, height: 200, marginTop: 24, borderColor: 'gray', alignItems: 'center', justifyContent: 'space-around'}}>
              <View style={{flexDirection: 'row', width: width, alignItems: 'center', padding: 12}}>
                <View style={{width: width * 0.45, alignItems: 'center', justifyContent: 'space-around'}}>
                  <Text style={{ fontSize: width * 0.035 }}>Pemasukan</Text>
                ...
                <View style={{width: width * 0.45, alignItems: 'center'}}>
                  <Text style={{ fontSize: width * 0.035 }}>Pengeluaran</Text>
              ...
              <TouchableOpacity
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  ...
                  <Text style={{fontSize: width * 0.035}}>Lihat Laporan Keuangan</Text>
                </View>
                  ...
                  return (
                    <View style={{flexDirection: 'column', width: width, paddingTop: 12}}>
                      ...
                      ? <View style={{flexDirection: 'row', width: width, alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'whitesmoke', height: 40}}>
                        <Text style={{width: width * 0.3, textAlign: 'center', color: 'grey', fontSize: width * 0.035}}>{dat.dateInput}</Text>
                        <Text style={{width: width * 0.5, textAlign: 'center', color: sum[ix] < 0 ? 'red' : 'green', fontWeight: '700', fontSize: width * 0.035}}>Untung {currencyFormat(parseInt(sum[ix]))}</Text>
                      </View> : null
                    }
                      {index === 0
                      ? <View style={{flexDirection: 'row', width: width, alignItems: 'center', paddingVertical: 12}}>
                        <Text style={{width: width * 0.3, textAlign: 'center', color: 'grey', fontSize: width * 0.035}}>Catatan</Text>
                        <Text style={{width: width * 0.4, textAlign: 'center', color: 'grey', fontSize: width * 0.035}}>Pemasukan</Text>
                        <Text style={{width: width * 0.3, textAlign: 'center', color: 'grey', fontSize: width * 0.035}}>Pengeluaran</Text>
                      </View> : null
                    }
                      ...
                      <View style={{flexDirection: 'row', width: width, alignItems: 'center', justifyContent: 'center'}}>
                        ...
                        <View style={{width: width * 0.3, alignItems: 'center'}}>
                          <Text style={{color: 'red', fontSize: width * 0.035}}>{dat.jenis === 'berikan' ? currencyFormat(parseInt(dat.nominal)) : '-'}</Text>
                        </View>
                      </View>
                    </View>
                  )
